        ...
        <main>
            <section id="mainContent">
                ...
                <article class="content-article">
                    ...
                    <div class="board">
                        <div class="search">
                            <form action="searchBoard.php" name="searchBoard" method="get">
                                <fieldset>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <?php
                                    //board + member
                                    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.boardView, b.regTime FROM myBoard b JOIN myMember m ON (m.memberID = b.memberID) ORDER BY boardID DESC LIMIT 5";
                                    ...
                                    if( $result ){
                                        ...
                                        if( $count > 0 ){
                                            for( $i=1; $i<=$count; $i++ ){
                                                ...
                                                echo "<td class='left'>".$info['boardTitle']."</td>";
                                            ...
                                            echo "<tr><td colspan='4'>게시글이 없습ㄴ디ㅏ.</td></tr>";
                                        }
                                    } else {
                                        echo "관리자에게 문의하세요 : 에러 발생";
                                    }
                                ?>
                ...
                <article class="flow-article">
                    ...
                    <section class="section-comment">
                        ...
                        <div class="comment-list">
                            ...
                            <div>
                                <p>선생님 항상 좋은 강의 감사합니닷! 선생님 항상 좋은 강의 감사합니닷!
                                    항상 잘 보고 있답니당👍</p>
                                <div class="icon">
                                    <img src="../assets/img/stu01.png" alt="이정아">
                                    <span>#ksys**</span>
